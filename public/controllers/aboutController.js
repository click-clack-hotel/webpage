...
app.controller('aboutController', function($scope, $http) {
  ...
  //ABOUT MED
  $scope.img_about_med = 'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1562619105669_Entrada%2010a.jpg?alt=media&token=26cbda29-5bcf-42e6-b845-a2dd4f55a7f4'
  $scope.text_about_med = "Bringing Click Clack's award-winning and eyebrow-raising design to the country’s city of eternal spring, the Click Clack Medellín is a 123-room playground of interactive experiences and luxurious comfort, located at the heart of El Poblado. From the luscious green outdoor lobby lined with restaurants and a gallerie, to the jaw-dropping mountain views, unusual design details will make you laugh out loud, think again, or perhaps even learn something new. Just remember: curiosity will be duly rewarded."
  ...
  $scope.carousel_about_med = [
    {link:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1562619139583_Lobby%20Medellin.jpg?alt=media&token=e3567ed6-29fb-4fc6-b16a-3fd08bff948a'},
    {link:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1562619133681_Kitchen%203.jpg?alt=media&token=a2e71705-bbbe-445c-96dd-945174efee36'},
  ]
})
