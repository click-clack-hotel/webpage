...
app.controller('specialsController', function($scope, $http) {
  ...
  //SPECIALS BOG
  $scope.img_specials_bog = 'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1551886858349_click-6.jpg?alt=media'
  $scope.specials_bog = [
    {
      title:'BED PICNIC',
      ...
      text_es:"No dejes que un día lluvioso te dañe el plan de picnic en el parque. Nosotros te armamos uno en tu propia habitación. Y lo mejor es que ni siquiera te tienes que vestir.",
      hashtag:'#KKBedPicnic',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223868182_bed-picnic.jpg?alt=media'
    },
    {
      title:'TOURS',
      title_es:'TOURS',
      ...
      text_es:"Sabemos que nuestras habitaciones son muy cómodas, pero sería una lástima que vinieras a uno de los paises con mayor biodiversidad del planeta y no salieras a explorar un poco. Así que déjanos que organicemos todo mientras tú te pones los zapatos (o el bikini, más bien), y descubre los mejores sitios de Bogotá o Colombia en general, tras una selección de experiencias exclusivas de Click Clack.",
      hashtag:'#KKTours',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223860210_tours.jpg?alt=media'
    },
    {
      title:'BEAUTY TO GO',
      title_es:'BEAUTY TO GO',
      ...
      hashtag:'#KKBeauty2Go',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223852855_beauty.jpg?alt=media'
    },
    {
      title:'MINIBAR',
      title_es:'MINIBAR',
    ...
    },
    {
      ...
      text_es:"Estamos orgullosos de presentar nuestra propia selección curada de productos de los diseñadores independientes más prometedores de Colombia. Compra todos tus regalos desde la comodidad del hotel. Así te los regales a ti mismo. Eso también cuenta, ¿no?",
      hashtag:'#KKDesignShop',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223844545_design-shop.jpg?alt=media'
    },
    {
      title:'PILLOW MENU',
      title_es:'PILLOW MENU',
      ...
      text_es:"El gusto de cada uno es diferente, sobre todo cuando se trata de las almohadas. Pide nuestro menú de almohadas en la recepción y escoge el accesorio perfecto para una noche de ensueño. O para una pelea de almohadas. ¡O para lo que sea que tengas planeado!",
      hashtag:'#KKPillowMenu',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223814968_pillow-menu.jpg?alt=media'
    },
    {
      title:'7+1 CAPITAL SINS KITS',
      title_es:'7+1 PECADOS CAPITALES',
      ...
      text_es:"Al fin y al cabo, sólo somos humanos. No estamos aquí para juzgar tus pecados; todo lo contrario. Con nuestros kits para los Siete Pecados Capitales (más uno)  te ayudamos a pecar con estilo. Trátese de avaricia, de lujuria o de pereza pura y dura, llama no más a la recepeción y confiesa tus pecados. Te prometemos que te sentirás mucho mejor.",
      hashtag:'#KKITS',
      img:'https://firebasestorage.googleapis.com/v0/b/click-clack-5db9f.appspot.com/o/flamelink%2Fmedia%2F1547223806686_sins.jpg?alt=media'
    }
  ]
})
