...
app.controller('home', function($scope, $http) {
  ...
  request.then(function (data) {
    $scope.vimeoBogota = data.data.vimeoLink;
    var request_w = $http.get("https://us-central1-click-clack-5db9f.cloudfunctions.net/getWhatsApp")
    .then(function(response) {
      $scope.data = response;
      return response;
    });
    request_w.then(function (data) {
      $scope.whatsapp = 'https://api.whatsapp.com/send?phone='+data.data.number+'&text='+data.data.defaultMessageEnglish
