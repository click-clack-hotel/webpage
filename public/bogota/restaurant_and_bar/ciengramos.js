...
app.controller('ciengramos', function($scope, $http) {
  ...
  request.then(function (data) {
    ...
    var request_2 = $http.get("https://us-central1-click-clack-5db9f.cloudfunctions.net/getCiengramos")
    .then(function(response) {
      $scope.data = response;
      return response;
    });
    request_2.then(function (data) {
      $scope.text_ciengramos_bog = data.data.textEnglish;
      $scope.text_ciengramos_bog_es = data.data.textSpanish;
