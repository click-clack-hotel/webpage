...
app.controller('xs', function($scope, $http) {
  ...
  request.then(function (data) {
    ...
    var request_2 = $http.get("https://us-central1-click-clack-5db9f.cloudfunctions.net/getXsMedellin")
    .then(function(response) {
      $scope.data = response;
      return response;
    });
    request_2.then(function (data) {
      $scope.room = $scope.name_xs
