...
app.controller('click_clack_kitchen', function($scope, $http) {

  $scope.id = 'restaurant_and_bar';
  $scope.title_click_clack_kitchen = 'Click Clack ';
  $scope.subtitle_click_clack_kitchen = 'Kitchen';

  var request_2 = $http.get("https://us-central1-click-clack-5db9f.cloudfunctions.net/getClickClackKitchen")
  ...
  $scope.sendMail = function() {
    ...
    var req = {
     method: 'POST',
     url: 'https://us-central1-click-clack-5db9f.cloudfunctions.net/sendMailclick_clack_kitchen',
     headers: {
