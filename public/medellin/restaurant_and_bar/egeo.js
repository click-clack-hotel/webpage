...
app.controller('egeo', function($scope, $http) {
  ...
  var request_2 = $http.get("https://us-central1-click-clack-5db9f.cloudfunctions.net/getEgeo")
  ...
  $scope.sendMail = function() {
    ...
    var req = {
     method: 'POST',
     url: 'https://us-central1-click-clack-5db9f.cloudfunctions.net/sendMailegeo',
     headers: {
